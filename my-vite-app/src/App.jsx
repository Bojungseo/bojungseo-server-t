  ...
  const QuickLinksVertical = () => {
    ...
    return (
      <div className="bg-white/50 backdrop-blur-md p-4 rounded-lg shadow-md w-64">
        <h2 className="text-xl font-bold mb-3 border-b pb-2 text-gray-700 text-center">
          지원기능
        </h2>
          ...
          <div className="flex justify-between items-start gap-8 mb-8">
            <div className="bg-white/50 backdrop-blur-md p-6 rounded-lg shadow-md max-w-sm w-full">
              ...
              <ul className="space-y-2">
                <li className="p-3 border-b hover:bg-gray-100 cursor-pointer rounded-md">
                  필독! 11월 시스템 정기 점검 안내
                </li>
                <li className="p-3 border-b hover:bg-gray-100 cursor-pointer rounded-md">
                  신규 기능 '조건 검색' 사용 가이드
                </li>
                <li className="p-3 hover:bg-gray-100 cursor-pointer rounded-md">
                  관리자 패널 사용 변경사항 공지
                </li>
              </ul>
            </div>
